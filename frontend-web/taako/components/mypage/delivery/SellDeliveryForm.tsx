...
export default function SellDeliveryForm({ auctionId, onClose, onRegistered }: SellDeliveryFormProps) {
  ...
  const onRegister = useCallback(async () => {
    ...
    try {
      setSubmitting(true);
      await handlerSellerAddress(auctionId, addressId);
  ...
  }, [auctionId, addressId, handlerSellerAddress, onClose, onRegistered]);
